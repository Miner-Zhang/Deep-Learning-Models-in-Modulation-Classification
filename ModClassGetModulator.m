function modulator = ModClassGetModulator(modType, sps, fs)
%ModClassGetModulator Modulation function selector
%   MOD = ModClassGetModulator(TYPE,SPS,FS) returns the modulator
